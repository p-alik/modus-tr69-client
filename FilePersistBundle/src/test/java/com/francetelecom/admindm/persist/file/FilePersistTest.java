...
public class FilePersistTest extends TestCase {
	...
	public void testPersistParameterValueLong() throws Exception {
		...
		fp2.initializeData();
		assertEquals(value, fp2.restoreParameterValue("test", FilePersist.LONG));
		fp.persist("test3", null, 0, value, FilePersist.UINT);
		fp2 = new FilePersist();
		fp2.initializeData();
		assertEquals(value, fp2.restoreParameterValue("test3", FilePersist.UINT));
		fp.persist("test4", null, 0, value, FilePersist.DATE);
		fp2 = new FilePersist();
		fp2.initializeData();
		assertEquals(value, fp2.restoreParameterValue("test4", FilePersist.DATE));
	}
	...
	public void testPersistParameterValueInt() throws Exception {
		...
		assertEquals(value, fp2.restoreParameterValue("test2", FilePersist.INT));
	}
	...
	public void testPersistParameter0Subscriber() throws Exception {
		...
		fp.initializeData();
		String[] values = {};
		fp.persist("Device.Manufacturer.Name", values, 2, Boolean.TRUE, FilePersist.BOOLEAN);
		FilePersist fp2 = new FilePersist();
		fp2.initializeData();
		assertArrayEquals(values, fp2.restoreParameterSubscriber("Device.Manufacturer.Name"));
		// fp2.values.list(System.out);
	}
	...
	public void testPersistParameterNotification() throws Exception {
		...
		FilePersist fp2 = new FilePersist();
		fp2.initializeData();
		assertTrue(2 == fp2.restoreParameterNotification("Device.Manufacturer.Name"));
	}
	...
	public void testPersistParameterNotification0() throws Exception {
		...
		fp.initializeData();
		String[] values = { "test1", "test2" };
		fp.persist("Device.Manufacturer.Name", values, 0, Boolean.TRUE, FilePersist.BOOLEAN);
		FilePersist fp2 = new FilePersist();
		fp2.initializeData();
		assertTrue(0 == fp2.restoreParameterNotification("Device.Manufacturer.Name"));
	}
	 ...
	 *            the tab2
	 */
	public void assertArrayEquals(final Object[] tab1, final Object[] tab2) {
		if (tab1 == tab2)
			return;
