...
public final class HTTPUploadProtocol implements IUploadProtocol {
	...
	public void onUpload(final Upload d) throws Fault {
		...
		try {
			...
			con.setRequestProperty("Content-Length", "" + getFileLength(d.getFilename()));
			...
			System.out.println("dotLine: " + dotLine);
	 ...
	 */
	protected void writeFile(OutputStream os, String filename) throws IOException {
