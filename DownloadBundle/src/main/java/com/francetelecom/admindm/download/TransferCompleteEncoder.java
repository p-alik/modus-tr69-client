...
public class TransferCompleteEncoder implements RPCEncoder {
	...
	public final Element encode(final RPCMethod method) {
		...
		Element eTransferComplete = new Element();
		...
		eStartTime.addChild(Element.TEXT, Soap.convertDate2String(transferComplete.getStartTime()));
		Element eCompleteTime = new Element();
		eCompleteTime.setName("CompleteTime");
		eCompleteTime.addChild(Element.TEXT, Soap.convertDate2String(transferComplete.getCompleteTime()));
