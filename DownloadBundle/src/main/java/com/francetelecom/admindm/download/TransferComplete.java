...
public final class TransferComplete implements RPCMethod, Serializable {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((commandKey == null) ? 0 : commandKey.hashCode());
		result = prime * result + (int) (completeTime ^ (completeTime >>> 32));
		result = prime * result + ((faultStruct == null) ? 0 : faultStruct.hashCode());
