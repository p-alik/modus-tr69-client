...
public class EngineTest extends TestCase {
	...
	public void testPersistance() throws IOException, Fault {
		TestUtil.COMMENT("Verify that download and TransfertComplete " + "will persist when store and restore2.");
		TestUtil.TRACE(this);
	...
	public void testIsMulticastDownload() throws Exception {
		...
		assertFalse(result);
		result = Engine.isMulticastDownload("http://239.254.254.254/toto.html");
		assertTrue(result);
