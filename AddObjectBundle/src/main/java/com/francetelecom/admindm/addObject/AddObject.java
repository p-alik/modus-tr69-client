...
public final class AddObject implements RPCMethod {
	 ...
	 *            the parameter key
	 */
	public AddObject(final File pSequenceIdFile, final String pObjectName, final String pParameterKey) {
		super();
	 ...
	 * @return the long
	 */
	protected long generateObjectId(final String pObjectName, final IParameterData data) {
