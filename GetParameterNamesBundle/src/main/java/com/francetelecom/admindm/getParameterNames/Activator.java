...
public final class Activator implements BundleActivator {
	...
	public void start(final BundleContext context) throws Exception {
		...
		if (rpcMethodMngServiceRef != null) {
			...
			rpcMng.registerRPCEncoder("GetParameterNamesResponse", new GetParameterNamesResponseEncoder());
			rpcMng.registerRPCDecoder("GetParameterNames", new GetParameterNamesDecoder());
			Log.info("Start RPC Method GetParameterNames");
		} else {
			Log.error("Unable to start GetParameterNames: " + "RPCMethodMngService is missing");
		}
	}
