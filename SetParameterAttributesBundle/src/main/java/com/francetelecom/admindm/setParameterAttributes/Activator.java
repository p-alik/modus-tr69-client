...
public final class Activator implements BundleActivator {
	...
	public void start(final BundleContext context) throws Exception {
		...
		if (rpcMethodMngServiceRef != null) {
			...
			rpcMng.registerRPCEncoder("SetParameterAttributesResponse", new SetParameterAttributesResponseEncoder());
			rpcMng.registerRPCDecoder("SetParameterAttributes", new SetParameterAttributesDecoder());
			Log.info("Start RPC Method SetParameterAttributes");
		} else {
			Log.error("Unable tp start SetParameterAttributes: " + "RPCMethodMngService is missing");
		}
	}
