...
public final class ScheduleInformTest extends TestCase {
	...
	public void testComputeNextOccurencyDelay() throws Exception {
		...
		param.setName("InternetGatewayDevice.ManagementServer." + "PeriodicInformInterval");
		...
		param = new Parameter();
		param.setName("InternetGatewayDevice.ManagementServer." + "PeriodicInformEnable");
		param.setType(ParameterType.BOOLEAN);
		param.setValue(Boolean.FALSE);
		parameterData.addOrUpdateParameter(param, "ACS");
		// ----------------
		param = new Parameter();
		param.setName("InternetGatewayDevice.ManagementServer." + "PeriodicInformTime");
