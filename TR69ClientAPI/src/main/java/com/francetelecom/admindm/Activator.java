...
public final class Activator implements BundleActivator {
	...
	public void start(final BundleContext context) throws Exception {
		...
		context.registerService(RPCMethodMngService.class.getName(), RPCMethodMng.getInstance(), null);
		RPCMethodMng.getInstance().registerRPCMethod("Inform");
		RPCMethodMng.getInstance().registerRPCDecoder("InformResponse", new InformResponseDecoder());
	}
