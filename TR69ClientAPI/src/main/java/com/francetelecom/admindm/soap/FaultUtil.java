...
public final class FaultUtil {
	...
	public static final String STR_FAULT_9001 = "Request denied (no reason specified)";
	/**
	 ...
	 */
	public static final String STR_FAULT_9008 = "Attempt to set a non-writable parameter";
	/**
	 ...
	 */
	public static final String STR_FAULT_9012 = "File transfer server authentification failure";
	/** The Constant STR_FAULT_9013. */
	public static final String STR_FAULT_9013 = "Unsupported protocol for file transfer";
	/** The Constant STR_FAULT_9014. */
	public static final String STR_FAULT_9014 = "Download failure: unable to join multicast group";
	/** The Constant STR_FAULT_9015. */
	public static final String STR_FAULT_9015 = "Download failure: unable to join file server";
	/** The Constant STR_FAULT_9016. */
	public static final String STR_FAULT_9016 = "Download failure: unable to access file";
	/** The Constant STR_FAULT_9017. */
	public static final String STR_FAULT_9017 = "Download failure: unable to complete download";
	/** The Constant STR_FAULT_9018. */
	public static final String STR_FAULT_9018 = "Download failure: file corrupted";
	/** The Constant STR_FAULT_9019. */
	public static final String STR_FAULT_9019 = "Download failure: file authentification failure";
	...
	public static String getType(final int code) {
		...
		if (code == FAULT_9003 || code == FAULT_9005 || code == FAULT_9006 || code == FAULT_9007 || code == FAULT_9008) {
			result = "Client";
		}
		return result;
	}
