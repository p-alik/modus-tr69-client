...
public final class ParameterAttributeStruct {
	 ...
	 *            the notification
	 */
	public ParameterAttributeStruct(final String pName, final String[] pAccessList, final int pNotification) {
		super();
	...
	public Element encoded() {
		...
		value.append("]");
		eAccessList.setAttribute(Soap.getXsiNameSpace(), "arrayType", value.toString());
