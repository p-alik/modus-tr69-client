...
public interface IParameterData {
	 ...
	 *             the fault
	 */
	void addOrUpdateParameter(final Parameter param, final String updater) throws Fault;
	 ...
	 * 
	 * @param filters
	 *            string array of full or partial path of a parameter
	 * @return List of parameter
	 * @throws Fault
	 *             in case of parameterName'array contains unknown parameter or
	 *             unknown partial path.
	 */
