...
public final class EventBehavior {
	 ...
	 * @param pRetryPolicy
	 *            the retry policy
	 * @param pSuccessfulDelivery
	 *            the ACS Response for successful delivery
	 */
	public EventBehavior(final boolean pMustBeSingle, final int pRetryPolicy, final String pSuccessfulDelivery) {
	...
	/**
	 * Sets the successful delivery RPCMethod name who will acknowledge this
	 * kind of event.
	 * 
	 * @param pSuccessfulDelivery
	...
	public String toString() {
		String toString = this.getClass().getName() + "[" + "retryPolicy=" + this.retryPolicy + ",count=" + this.count
				+ ",mustBeSingle=" + this.mustBeSingle + ",successfulDelivery=" + this.successfulDelivery + "]";
		return toString;
	}
