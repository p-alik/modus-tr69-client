...
public interface EventCode {
	...
	/** The Constant DU_STATE_CHANGE_COMPLETE */
	String DU_STATE_CHANGE_COMPLETE = "11 DU STATE CHANGE COMPLETE";
	...
	/** The Constant M_CHANGE_DU_STATE. */
	String M_CHANGE_DU_STATE = "M ChangeDUState";
