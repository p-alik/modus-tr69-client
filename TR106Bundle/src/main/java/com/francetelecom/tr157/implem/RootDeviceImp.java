...
public class RootDeviceImp extends RootDevice {
	 ...
	 *            the u pn p device
	 */
	public RootDeviceImp(IParameterData data, String basePath, UPnPDevice pUPnPDevice) {
		super(data, basePath);
	...
	public void initialize() throws Fault {
		...
		// UUID
		String uuid = (String) upnpDevice.getDescriptions(null).get(UPnPDevice.UDN);
		...
		// USN
		String usn = (String) upnpDevice.getDescriptions(null).get(UPnPDevice.UDN) + "::" + getDeviceType(upnpDevice);
