...
public class SampleSetImpl extends SampleSet implements Observer {
	...
	public void initialize() throws Fault {
		...
		getParamSampleInterval().addCheck(new SampleIntervalParameterChecker(getData()));
		...
		getParamParameterNumberOfEntries().setGetter(new GetterForList(parameterList, ParameterType.UINT));
	...
	public ParameterImpl addParameter() {
		ParameterImpl parameter = new ParameterImpl(getData(), getBasePath() + "Parameter."
