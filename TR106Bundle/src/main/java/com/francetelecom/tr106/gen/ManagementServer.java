...
public class ManagementServer {
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createSTUNUsername()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
				+ "STUNUsername");
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createSTUNMaximumKeepAlivePeriod()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
	...
	/**
	 * Address and port to which an ACS MAY send a UDP Connection Request the
	 * CPE (see {{bibref|TR-069a2|Annex G}}). This parameter is in the form of
	 * an Authority element as defined in The value MUST be in one of the
	 * following two forms: : host:port : * When {{param|STUNEnable}} is
	 * {{true}}, the ''host'' and ''port'' of this parameter MUST represent the
	 * public address and port to the NAT binding through which the ACS can send
	 * UDP Connection messages (once this information is learned by the CPE
	 * through the of STUN). * When {{param|STUNEnable}} is {{false}}, the
	 * ''host'' and portions of the URL MUST represent the local IP address and
	 * port on the CPE is listening for UDP Connection Request messages. The
	 * second of this parameter MAY be used only if the port value is equal to
	 * 
	 */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createUDPConnectionRequestAddress()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createSTUNServerAddress()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
				+ "STUNServerAddress");
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createConnectionRequestPassword()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
	...
	/**
	 * nullNote that on a factory reset of the CPE, the value of this might be
	 * reset to its factory value. If an ACS modifies the value of parameter, it
	 * SHOULD be prepared to accommodate the situation that original value is
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createPassword()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
	...
	/**
	 * Present only for a CPE that supports the Kicked RPC method. URL, as
	 * defined in {{bibref|RFC3986}}, from which the CPE can be to initiate the
	 * Kicked RPC method call. MUST be an absolute URL a host name or IP address
	 * as would be used on the LAN side of the
	 * 
	 */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createKickURL()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createNATDetected()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
				+ "NATDetected");
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createPeriodicInformInterval()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createSTUNServerPort()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
				+ "STUNServerPort");
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createSTUNEnable()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
				+ "STUNEnable");
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createPeriodicInformEnable()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
    ...
    */
	...
	/**
	 * An absolute time reference in UTC to determine when the CPE will the
	 * periodic Inform method calls. Each Inform call MUST occur at reference
	 * time plus or minus an integer multiple of the {{param}} is used only to
	 * set the ''phase'' of the periodic Informs. actual value of {{param}} can
	 * be arbitrarily far into the past or For example, if
	 * {{param|PeriodicInformInterval}} is 86400 (a day) if {{param}} is set to
	 * UTC midnight on some day (in the past, or future) then periodic Informs
	 * will occur every day at UTC These MUST begin on the very next midnight,
	 * even if {{param}} refers a day in the future. The Unknown Time value
	 * defined in 3.2}} indicates that no particular time reference is
	 * specified. That the CPE MAY locally choose the time reference, and needs
	 * only to to the specified {{param|PeriodicInformInterval}}. If absolute
	 * time not available to the CPE, its periodic Inform behavior MUST be the
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createPeriodicInformTime()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
				+ "PeriodicInformTime");
	...
	/**
	 * HTTP URL, as defined in {{bibref|RFC3986}}, for an ACS to make a Request
	 * notification to the CPE. In the form: : The ''host'' portion of the URL
	 * MAY be the IP address for the interface of the CPE in lieu of a host
	 * name.
	 */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createConnectionRequestURL()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
	...
	/**
	 * Present only for a CPE that provides a LAN-side web page to show during a
	 * file download. LAN-accessible URL, as defined in to which a web-server
	 * associated with the ACS MAY redirect a user's on initiation of a file
	 * download to observer the status of the
	 * 
	 */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createDownloadProgressURL()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
				+ "DownloadProgressURL");
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createUsername()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createSTUNMinimumKeepAlivePeriod()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createSTUNPassword()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
				+ "STUNPassword");
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createConnectionRequestUsername()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
	 ...
	 * {{true}}, the CPE SHOULD NOT use other means other than the ACS to out
	 * available upgrades. If {{false}}, the CPE MAY use other means this
	 * purpose. Note that an autonomous upgrade (reported via an "10 TRANSFER
	 * COMPLETE" Inform Event code) SHOULD be regarded as a upgrade if it is
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createUpgradesManaged()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
				+ "UpgradesManaged");
	 ...
	 * using the CPE WAN Management Protocol. This parameter MUST be in the of a
	 * valid HTTP or HTTPS URL. The ''host'' portion of this URL is by the CPE
	 * for validating the ACS certificate when using SSL or TLS. that on a
	 * factory reset of the CPE, the value of this parameter be reset to its
	 * factory value. If an ACS modifies the value of this it SHOULD be prepared
	 * to accommodate the situation that the original is restored as the result
	 * of a factory reset.
	 */
    ...
    */
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createParameterKey()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = this.data.createOrRetrieveParameter(this.basePath
				+ "ParameterKey");
