...
public class LAN {
	 ...
	 *            persistence
	 */
	public LAN(final IParameterData pData, final String pBasePath) {
		super();
		this.data = pData;
	 ...
	 * {{param|MACAddress}} is writable. * When {{false}}, is not writable, and
	 * the default MAC address assigned by the device be restored.
	 */
	 ...
	 */
	public final com.francetelecom.admindm.model.Parameter getParamMACAddressOverride() {
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createMACAddressOverride()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
	...
	/**
	 * The IP address of the current default gateway for this interface. ability
	 * to modify this parameter is OPTIONAL, and this parameter be modified if
	 * the {{param|AddressingType}} is
	 * 
	 */
	 ...
	 */
	public final com.francetelecom.admindm.model.Parameter getParamDefaultGateway() {
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createDefaultGateway()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
	...
	/**
	 * The current subnet mask. The ability to modify this parameter is and this
	 * parameter cannot be modified if the is {{enum|DHCP|AddressingType}}.
	 */
	 ...
	 * @return _SubnetMask
	 */
	public final com.francetelecom.admindm.model.Parameter getParamSubnetMask() {
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createSubnetMask()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
    ...
    */
	 ...
	 * @return _DHCPOption
	 */
	public final com.francetelecom.admindm.model.Parameter getParamDHCPOption() {
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createDHCPOption()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
    ...
    */
	 ...
	 * @return _MACAddress
	 */
	public final com.francetelecom.admindm.model.Parameter getParamMACAddress() {
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createMACAddress()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
	...
	/**
	 * The method used to assign an address to this interface. {{enum}} The to
	 * modify this parameter is OPTIONAL.
	 */
	 ...
	 */
	public final com.francetelecom.admindm.model.Parameter getParamAddressingType() {
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createAddressingType()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
	...
	/**
	 * The current IP address assigned to this interface. The ability to this
	 * parameter is OPTIONAL, and this parameter cannot be modified if
	 ...
	 * @return _IPAddress
	 */
	public final com.francetelecom.admindm.model.Parameter getParamIPAddress() {
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createIPAddress()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		...
		Getter urlGetter = new IPAdressGetter();
		param.setGetter(urlGetter);
		return param;
	}

	/**
	 * Comma-separated list of IP address of the DNS servers for this The
	 * ability to modify this parameter is OPTIONAL, and this parameter be
	 * modified if the {{param|AddressingType}} is If this parameter is
	 * modifiable, the device MAY ignore any DNS beyond the first two in the
	 * list.
	 */
	 ...
	 * @return _DNSServers
	 */
	public final com.francetelecom.admindm.model.Parameter getParamDNSServers() {
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createDNSServers()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
    ...
    */
	 ...
	 */
	public final com.francetelecom.admindm.model.Parameter getParamDHCPOptionNumberOfEntries() {
	 ...
	 *             exception
	 */
	public final com.francetelecom.admindm.model.Parameter createDHCPOptionNumberOfEntries()
			throws Fault {
		com.francetelecom.admindm.model.Parameter param;
		param = data.createOrRetrieveParameter(basePath
