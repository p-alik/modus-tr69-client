...
public class X_ORANGE_ServicesToInstall {
	...
	public X_ORANGE_ServicesToInstall(IParameterData pParameterData, String pBasePath) {
		this.parameterData = pParameterData;
		this.basePath = pBasePath;
		System.out.println("X_ORANGE_ServicesToInstall(: " + this.parameterData + ", : " + this.basePath + ")");
	}
	...
	private void createServicesToInstall() throws Fault {
		servicesToInstall = parameterData.createOrRetrieveParameter(parameterData.getRoot()
