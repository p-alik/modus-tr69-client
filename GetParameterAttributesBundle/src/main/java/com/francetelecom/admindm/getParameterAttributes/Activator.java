...
public final class Activator implements BundleActivator {
	...
	public void start(final BundleContext context) throws Exception {
		...
		if (rpcMethodMngServiceRef != null) {
			...
			rpcMng.registerRPCEncoder("GetParameterAttributesResponse", new GetParameterAttributesResponseEncoder());
			rpcMng.registerRPCDecoder("GetParameterAttributes", new GetParameterAttributesDecoder());
			Log.info("Start RPC Method GetParameterAttributes");
		} else {
			Log.error("Unable tp start GetParameterAttributes: " + "RPCMethodMngService is missing");
		}
	}
