 ...
 */
public final class StateModifier implements Setter, Getter, CheckCallBack {
	/** The bundle. */
	 ...
	 *            the state parameter
	 */
	public StateModifier(final IParameterData data, final Bundle pBundle, final Parameter pParam) {
		this.bundle = pBundle;
